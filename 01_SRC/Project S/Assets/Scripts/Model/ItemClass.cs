...
public class ItemClass {
    ...
    public static int GetCost(ItemType itemType) {
        switch (itemType) {
        default:
        case ItemType.ClothingNone:        return 0;
        case ItemType.Clothing1:          return 200;
        case ItemType.Clothing2:          return 300;
        case ItemType.Hat1:       return 50;
        case ItemType.Hat2:           return 50;
        case ItemType.Shoes1:     return 80;
        case ItemType.Shoes2:          return 120;
        }
    }
